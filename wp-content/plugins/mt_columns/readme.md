...
This WordPress plugin adds Columns to your ModernThemes WordPress themes.


== Installation ==

1. Download and unzip files. Or install MT: Columns plugin using the WordPress plugin installer. In that case, skip 2.
